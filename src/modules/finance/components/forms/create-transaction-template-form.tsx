...
import { useCreateTransactionTemplateMutation } from "@/modules/finance/mutations";
import {
...
export function CreateTransactionTemplateForm({
  wallets,
  categories,
  places,
}: {
  ...
  const mutation = useCreateTransactionTemplateMutation();
