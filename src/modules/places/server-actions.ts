...
export async function getPaginatedPlaceCategories(params: {
  paginate: Paginate;
  query?: string;
}) {
...
export async function getAllPlaceCategories(params: { query?: string } = {}) {
  const userId = await getCurrentUserId();
...
export async function getPaginatedPlaces(params: {
  paginate: Paginate;
  query?: string;
  categoryId?: string;
}) {
...
export async function createPlace(place: CreatePlaceFormType) {
  const userId = await getCurrentUserId();
...
export async function updatePlace(place: UpdatePlaceFormType) {
  await db
    .update(places)
    .set({
      categoryId: place.categoryId,
